...
EDMPMQTTClient Copy To MQTT-Client
* bugfix:
* 1.+ (MQTTMessage *)messageFromData:(NSData *)data protocolLevel:(MQTTProtocolVersion)protocolLevel
* 2.+ (MQTTMessage *)unsubscribeMessageWithMessageId:(UInt16)msgId
